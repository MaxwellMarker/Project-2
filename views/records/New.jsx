                ...
                <div className='formDiv'>
                    {record
                        ? <form action="/prs" method='POST'>
                            <h1 className='newHeader'>New PR</h1>
                            ...
                            <input className='formInput' type="text" name="name" id="name" required={true} defaultValue={record.name} autoComplete='off' /><br />
                            ...
                            <textarea className='formInput' name="description" id="notes" cols="30" rows="5"></textarea><br />
                        ...
                        : <form action="/prs" method='POST'>
                            ...
                            <label className='formLabel' htmlFor="name">Exercise Name</label>
                            <input className='formInput' type="text" name="name" id="name" required={true} /><br />
                            <label className='formLabel' htmlFor="reps">Reps</label>
